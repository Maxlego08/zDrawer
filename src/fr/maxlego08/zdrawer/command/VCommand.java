package fr.maxlego08.zdrawer.command;
...
import fr.maxlego08.zdrawer.zcore.utils.commands.Tab;
import org.bukkit.command.CommandSender;
import org.bukkit.entity.Player;

import fr.maxlego08.zdrawer.save.Config;
import fr.maxlego08.zdrawer.zcore.utils.commands.Arguments;
...
public abstract class VCommand extends Arguments {
	 ...
	 * @param plugin
	 */
	public VCommand(DrawerPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(DrawerPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(DrawerPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(DrawerPlugin plugin, CommandSender sender, String[] args) {
