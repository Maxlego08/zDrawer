package fr.maxlego08.zdrawer.inventory;
...
import fr.maxlego08.zdrawer.zcore.utils.inventory.InventoryResult;
...
import fr.maxlego08.zdrawer.zcore.utils.builder.ItemBuilder;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected DrawerPlugin plugin;
	...
	protected InventoryResult preOpenInventory(DrawerPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(DrawerPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, DrawerPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, DrawerPlugin plugin, Player player) {
	}
